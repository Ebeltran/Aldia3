 ...
 * @author ebeltran
 */
@FacesConverter("ciudadConv")
public class CiudadConv  extends ValueChangeConverter { 

    @Override
    public Object getAsChangedObject(FacesContext fc, UIComponent uic, String value) {
